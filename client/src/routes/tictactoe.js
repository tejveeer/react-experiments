...
const GameHistory = ({ data, idx, setGameHistory, deleteGameHistory }) => {
  ...
  return (
    <>
      <li key={id}>
        <div className="game-id" onClick={() => setGameHistory(history)}>Game {idx + 1}</div>
        <div
          className="delete"
      ...
      <div className="outer">
        ...
        <div className="area">
          <div className="game">
            <div className="board">
              {board.map((val, idx) => (
                <button key={idx} onClick={() => setBoardPosition(idx)}>
                  {val}
                </button>
              ))}
            </div>
          ...
          <div className="game-history">
            {history.map((_, idx) => (
              <div className="previous-move" onClick={() => resetBoard(idx)}>
                Move {idx + 1}
              </div>
            ))}
          </div>
